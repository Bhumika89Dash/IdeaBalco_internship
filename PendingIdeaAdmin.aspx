<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="PendingIdeaAdmin.aspx.cs" Inherits="IDEA_BALCO_1.PendingIdeaAdmin" %>
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card" style="height: auto; width: auto; top: 0; left: 0; margin-left: 0">
            <div class="card-body">
                 <h5 class="card-title">Pending Ideas</h5><asp:TextBox ID="txtsearch" runat="server" Width="300px" placeholder="Search here..." AutoPostBack="true" OnTextChanged="txtsearch_TextChanged"></asp:TextBox><br /><br />
                <div class="ibox-content">
                  ...
                  <div class="col-sm-3">
                    ...
                    <div class="panel-body">
                            ...
                            <ItemTemplate>
                                <asp:CheckBox ID="ChkCntrl" runat="server" OnCheckedChanged="ChkCntrl_CheckedChanged" />
                                        ...
                                        <asp:BoundField DataField="Emp_Dept" HeaderText="Emp Dept." />
                   ...
                   <br />
                       ...
                       <div class="row mb-2" >
                  <label for="inputText" class="col-sm-2 col-form-label"><b>Select Type
                  ...
                  <label for="inputText" class="col-sm-2 col-form-label"><b>Select Department
