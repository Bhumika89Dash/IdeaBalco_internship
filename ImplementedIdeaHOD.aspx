<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ImplementedIdeaHOD.aspx.cs" Inherits="IDEA_BALCO_1.ImplementedIdeaHOD" %>
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card" style="top: 10px; left: 0; margin-left: 0; height:auto">
            <div class="card-body">
                 <h5 class="card-title">Implemented Ideas</h5><asp:TextBox ID="txtsearch" runat="server" Width="300px" placeholder="Search here..." AutoPostBack="true" OnTextChanged="txtsearch_TextChanged"></asp:TextBox><br /><br />
