<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ImplementedIdeaAdmin.aspx.cs" Inherits="IDEA_BALCO_1.ImplementedIdeaAdmin" %>
            ...
            <div class="col-lg-12">
                ...
                <div class="card"  style="top: 10px; left: 0; margin-left: 0; height:auto">
                    <div class="card-body">
                        ...
                        <asp:TextBox ID="txtsearch" runat="server" Width="300px" placeholder="Search here..." AutoPostBack="true"></asp:TextBox><br />
                        <br />
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" CssClass="grid" AllowPaging="True" AutoGenerateColumns="False" GridLines="Horizontal" Width="100%" EmptyDataText="No Data Found" OnPageIndexChanging="GridView1_PageIndexChanging" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4">
                                        <Columns>
                                            <asp:TemplateField HeaderText="#ID">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lblid" Text='<%# Eval("AutoID") %>' OnClick="lblid_Click" runat="server"></asp:LinkButton>
                                                </ItemTemplate>
